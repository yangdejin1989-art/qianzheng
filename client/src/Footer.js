// Footer.js
// 动态底部组件，支持三列布局：关于我们、公司信息、联系方�?import React, { useEffect, useState } from 'react';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        &copy; {new Date().getFullYear()} 季舒签证. 保留所有权�?
      </div>
    </div>
  );
}
